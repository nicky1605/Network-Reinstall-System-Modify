...
then
	...
	echo -e "\n"
	sleep 1s
	wget --no-check-certificate -qO UI_Options.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/UI_Options.sh' && bash UI_Options.sh
fi
...
then
	...
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -dd 'https://odc.cxthhhhh.com/SyStem/OpenWRT-Virtualization-Servers/Stable/openwrt-x86-64-generic-squashfs-combined.img.gz'
fi
...
then
	...
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -dd 'https://odc.cxthhhhh.com/SyStem/OpenWRT-Virtualization-Servers/Stable/openwrt-x86-64-generic-squashfs-combined-efi.img.gz'
fi
...
then
	...
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -dd 'https://odc.cxthhhhh.com/SyStem/CentOS/CentOS_8.X_NetInstallation_Stable_v3.6.vhd.gz'
fi
...
then
	...
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -d 10 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -d 9 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -u 20.04 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -u 18.04 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -dd 'https://odc.cxthhhhh.com/SyStem/Windows_DD_Disks/Disk_Windows_Server_2019_DataCenter_CN_v5.1.vhd.gz'
fi
...
then
	...
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -dd 'https://odc.cxthhhhh.com/SyStem/Windows_DD_Disks/Disk_Windows_Server_2019_DataCenter_CN_v5.1_UEFI.vhd.gz'
fi
...
then
	...
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -dd 'https://odc.cxthhhhh.com/SyStem/Windows_DD_Disks/Disk_Windows_Server_2016_DataCenter_CN_v4.12.vhd.gz'
fi
...
then
	...
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -dd 'https://odc.cxthhhhh.com/SyStem/Windows_DD_Disks/Disk_Windows_Server_2012R2_DataCenter_CN_v4.29.vhd.gz'
fi
...
then
	...
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -dd 'https://odc.cxthhhhh.com/SyStem/Windows_DD_Disks/Disk_Windows_Server_2012R2_DataCenter_CN_v4.29_UEFI.vhd.gz'
fi
...
then
	...
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -dd $2
fi
...
then
	...
	echo -e "\n"
	sleep 10s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -c 6.10 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 10s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -d 8 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 10s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -d 7 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 10s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/Core_Install_v3.1.sh' && bash Core_Install.sh -u 16.04 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 10s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/Core_Install_v3.1.sh' && bash Core_Install.sh -u 14.04 -v 64 -a
fi
...
then
	...
	echo -e "\n"
	sleep 10s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -dd 'https://odc.cxthhhhh.com/SyStem/Windows_DD_Disks/Historical_File_Windows_DD_Disk/Disk_Windows_10_x64_Lite_by_CXT_v1.0.vhd.gz'
fi
...
then
	...
	echo -e "\n"
	sleep 10s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -dd 'https://odc.cxthhhhh.com/SyStem/Windows_DD_Disks/Disk_Windows_Server_2008R2_DataCenter_CN_v3.27.vhd.gz'
fi
...
then
	...
	echo -e "\n"
	sleep 10s
	wget --no-check-certificate -qO Core_Install.sh 'https://raw.githubusercontent.com/MeowLove/Network-Reinstall-System-Modify/master/CoreShell/Core_Install_v3.1.sh' && bash Core_Install.sh -dd 'https://odc.cxthhhhh.com/SyStem/Windows_DD_Disks/Disk_Windows_Server_2003_DataCenter_CN_v7.1.vhd.gz'
fi
